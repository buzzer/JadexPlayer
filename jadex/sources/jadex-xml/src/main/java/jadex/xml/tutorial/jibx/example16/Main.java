...
public class Main
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		InputStream is = SUtil.getResource("jadex/xml/tutorial/jibx/example16/data1.xml", null);
		Object object1 = xmlreader.read(is, null, null);
		is.close();
		is = SUtil.getResource("jadex/xml/tutorial/jibx/example16/data2.xml", null);
