 ...
 * @since  Jan 18, 2006
 */
public class DIntegerArray extends ADelegate
{
	/** 
	 * @param o
	 * @param mill
	...
	public void persist(Object o, ICruncher mill, ClassLoader classloader)
	{
		...
		for(int i=0; i<len; i++) {
			mill.addToken(Integer.toString(a[i]));
		}
	}
	...
	public Object getInstance(Class clazz,IAssembler asm) throws Exception
	{
		...
		int[] a=new int[l];
		for(int i=0; i<l; i++) {
			a[i] = Integer.parseInt(asm.nextToken());
		}
		return a;
	}
}
 ...
 * LF
 *
 * Revision 1.4  2006/02/21 15:02:16  walczak
 * *** empty log message ***
 *
