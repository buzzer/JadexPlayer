...
public class BoardPanel extends JPanel
{
	...
	{
		"white_piece",	SGUI.makeIcon(BoardPanel.class, "/jadex/bdibpmn/examples/puzzle/images/white_piece.png"),
		"red_piece",	SGUI.makeIcon(BoardPanel.class, "/jadex/bdibpmn/examples/puzzle/images/red_piece.png"),
		"empty_field", SGUI.makeIcon(BoardPanel.class, "/jadex/bdibpmn/examples/puzzle/images/empty_field.png")
	});
