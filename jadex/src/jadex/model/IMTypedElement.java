...
public interface IMTypedElement extends IMReferenceableElement
{
	...
	/**
	 *  Get the update rate.
	 *  @return	The update rate. 0 for no updates.
	 */
	 ...
	 *  This is a little hack method to allow the underlying
	 *  runtime element to access the inital (fact/value)
	 *  always by calling getInitialValue().
	 *  @return The initial fact.
	 * /
	public IMInternalExpression getInitialValue();*/
}
