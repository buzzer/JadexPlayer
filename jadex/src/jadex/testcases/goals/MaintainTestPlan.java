...
public class MaintainTestPlan extends Plan
{
	...
	public void body()
	{
		...
		waitFor(100);
		if(IGoal.LIFECYCLESTATE_SUSPENDED.equals(maintain.getLifecycleState()))
			report.setSucceeded(true);
		else
		...
		waitFor(100);
		if(IGoal.LIFECYCLESTATE_ACTIVE.equals(maintain.getLifecycleState()))
			report.setSucceeded(true);
		else
