...
public interface IEventbase extends IElement
{
	 ...
	 */
	public void addInternalEventListener(String type, IInternalEventListener listener, boolean async);
	 ...
	 *  @param async True, if the notification should be done on a separate thread.
	 */
	public void addMessageEventListener(String type, IMessageEventListener listener, boolean async);
