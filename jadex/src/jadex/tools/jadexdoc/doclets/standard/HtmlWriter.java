...
public class HtmlWriter extends PrintWriter
{
	...
	// PathManager.urlfileseparator;

	/** The configuration. */
	protected StandardConfiguration configuration;
	 ...
	 * @throws java.io.IOException Exception raised by the FileWriter is passed on
	 * to next level.
	 * @throws UnsupportedEncodingException Exception raised by the
	 * OutputStreamWriter is passed on to next level.
	 */
	public HtmlWriter(StandardConfiguration configuration, String path, String filename, String docencoding)
	 ...
	 */
	public static Writer genWriter(StandardConfiguration configuration,
			...
			throws IOException, UnsupportedEncodingException
	{
		...
		if(path!=null)
		{
			PathManager.createDirectory(configuration, path);
		...
		if(docencoding==null)
		{
			...
			// todo: ? docencoding = oswriter.getEncoding();
			return oswriter;
		}
		else
		{
	 ...
	 * at the end.
	 * @param imgpng Image PNG file.
	 * @param imgname Image name.
	 * @param width Width of the image.
	 * @param height Height of the image.
	 */
	public void img(String imgpng, String imgname, int width, int height)
	{
		println("<IMG SRC=\"images/"+imgpng+".png\""
