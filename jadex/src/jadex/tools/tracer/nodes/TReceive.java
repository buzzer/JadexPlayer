 ...
 * @since Nov 10, 2004
 */
public class TReceive extends TAbstractC
{

  /** Default
   * Constructor: <code>TReceive</code>.
   * 
   * @param aid
   * @param trace
   */
  public TReceive(AgentIdentifier aid, OTrace trace)
  {
    super(aid, trace);
  }
  ...
  {
    return LookAndFeel.RECEIVE_ICON;
  }
  ...
  {
    return LookAndFeel.RECEIVE_COLOR;
  }
