 ...
 * @since Nov 10, 2004
 */
public class TWrite extends TBeliefAccess
{
  /** <code>type</code> a shortcut */
   ...
   * @param trace
   */
  public TWrite(AgentIdentifier aid, OTrace trace)
  {
    super(aid, trace);
  }

  /** 
   * @return the icon for a belief 
   * @see jadex.tools.tracer.nodes.TNode#getIcon()
   */
  public ImageIcon getIcon()
  {
    return LookAndFeel.WRITE_ICON;
  }
  ...
  {
    return LookAndFeel.WRITE_COLOR;
  }
