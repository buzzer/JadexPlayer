 ...
 * @since Nov 10, 2004
 */
public class TPlan extends TNode
{

  /** Default
   * Constructor: <code>TPlan</code>.
   * @param aid
   * 
   * @param trace
   */
  public TPlan(AgentIdentifier aid, OTrace trace)
  {
    super(aid, trace);
  }
