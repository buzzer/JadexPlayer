 ...
 * @since Nov 10, 2004
 */
public class TEvent extends TNode
{

  /** Default
   * Constructor: <code>TEvent</code>.
   * 
   * @param aid
   * @param trace
   */
  public TEvent(AgentIdentifier aid, OTrace trace)
  {
    super(aid, trace);
  }

  /** 
   * @return the icon for a plan
   * @see jadex.tools.tracer.nodes.TNode#getIcon()
   */
  public ImageIcon getIcon()
  {
    return LookAndFeel.EVENT_ICON;
  }
  ...
  {
    return LookAndFeel.EVENT_COLOR;
  }
 ...
 *
 * Revision 1.1.2.3  2004/11/30 12:37:03  9walczak
