 ...
 */
public class OBelief	extends OTrace implements java.beans.BeanInfo 
{
	//-------- constants ----------
	 ...
	 *  Create a new <code>OBelief</code>.
	 */
	public OBelief()  {
	}
		...
		if(pds==null) {
			try {
				pds = new java.beans.PropertyDescriptor[]{
					 new java.beans.PropertyDescriptor("access", this.getClass(), "getAccess", "setAccess")
				};
