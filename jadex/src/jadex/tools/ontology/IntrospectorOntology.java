...
/**
 *  Generated Java class for ontology jadex.tools.introspector.
 */
public class IntrospectorOntology
{
	//-------- constants --------

	/** The name of the ontology. */
	public static final String	ONTOLOGY_NAME	= "jadex.tools.introspector";
	...
	static
	{
		...
		nsp[nsp.length-1] = "jadex.tools.ontology";
