 ...
 */
public class ExecuteCommand	extends ToolAction implements java.beans.BeanInfo 
{
	//-------- constants ----------
	 ...
	 *  Create a new <code>ExecuteCommand</code>.
	 */
		...
		if(pds==null) {
			try {
				pds = new java.beans.PropertyDescriptor[]{
					 new java.beans.PropertyDescriptor("command", this.getClass(), "getCommand", "setCommand")
				};
