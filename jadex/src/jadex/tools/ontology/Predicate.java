...
/**
 *  Java class for concept Predicate of jadex.tools.tracer ontology.
 */
public abstract class Predicate implements java.beans.BeanInfo 
{
	//-------- constants ----------
	 ...
	 *  Create a new <code>Predicate</code>.
	 */
	public Predicate()  {
	}
