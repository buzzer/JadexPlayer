...
public class EnvironmentGui	extends JFrame
{
	...
	{
		"waste",	SGUI.makeIcon(EnvironmentGui.class, "/jadex/examples/cleanerworld/images/waste.png"),
		"wastebin",	SGUI.makeIcon(EnvironmentGui.class, "/jadex/examples/cleanerworld/images/wastebin.png"),
		"wastebin_full", SGUI.makeIcon(EnvironmentGui.class, "/jadex/examples/cleanerworld/images/wastebin_full.png"),
		"chargingstation", SGUI.makeIcon(EnvironmentGui.class, "/jadex/examples/cleanerworld/images/chargingstation.png"),
		"cleaner", SGUI.makeIcon(EnvironmentGui.class, "/jadex/examples/cleanerworld/images/cleaner.png"),
		"background", SGUI.makeIcon(EnvironmentGui.class, "/jadex/examples/cleanerworld/images/background.png"),
		"background_night", SGUI.makeIcon(EnvironmentGui.class, "/jadex/examples/cleanerworld/images/background_night.png")
	});
			...
			public void windowClosing(WindowEvent e)
			{
				...
				for(int i=0; i<cleaners.length; i++)
				{
					try
					{
						...
						kill.getParameter("agentidentifier").setValue(new AgentIdentifier(cleaners[i].getName(), true));
