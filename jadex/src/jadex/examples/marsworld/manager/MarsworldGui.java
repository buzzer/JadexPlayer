...
public class MarsworldGui	extends JFrame
{
	...
	{
		"background", SGUI.makeIcon(MarsworldGui.class, "/jadex/examples/marsworld/images/mars.png"),
		"homebase", SGUI.makeIcon(MarsworldGui.class, "/jadex/examples/marsworld/images/homebase.png"),
		"target", SGUI.makeIcon(MarsworldGui.class, "/jadex/examples/marsworld/images/target.png"),
		"sentry", SGUI.makeIcon(MarsworldGui.class, "/jadex/examples/marsworld/images/sentryagent.png"),
		"production", SGUI.makeIcon(MarsworldGui.class, "/jadex/examples/marsworld/images/productionagent.png"),
		"carry", SGUI.makeIcon(MarsworldGui.class, "/jadex/examples/marsworld/images/carryagent.png")
	});
...
//		images.put("background", loadImage(BACKGROUND_ICON_PATH));
		...
		this.map	= createMarsworldPanel(env);
