...
/**
 *  Java class for concept Prey of hunterprey_beans ontology.
 */
public abstract class PreyData	extends Creature implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this Prey.
	...
	/**
	 * Persist this Prey using the nuggets utility.
	 * @param c 
	 */
	...
	public void _set(String a, Object v) { //
		switch(hash(a)) {
		case 0: name =  (String)v; return;
		case 1: worldwidth =  Integer.parseInt((String)v); return;
		case 2: leaseticks =  Integer.parseInt((String)v); return;
		case 3: aid =  (AgentIdentifier)v; return;
		case 4: location =  (Location)v; return;
		case 5: worldheight =  Integer.parseInt((String)v); return;
		case 6: points =  Integer.parseInt((String)v); return;
		case 7: age =  Integer.parseInt((String)v); return;
		case 8: visionrange =  Integer.parseInt((String)v); return;
		}                        
	}
...
private static final int hash(String name) {
  int h=0;
  int c=name.length();
   h += 836975853*name.charAt(2);
   if (c<=5) return (h>>>15)%9;
   h += 125173267*name.charAt(5);
   return (h>>>15)%9;
}
