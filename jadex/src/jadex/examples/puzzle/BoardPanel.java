...
public class BoardPanel extends JPanel
{
	...
	{
		"white_piece",	SGUI.makeIcon(BoardPanel.class, "/jadex/examples/puzzle/images/white_piece.png"),
		"red_piece",	SGUI.makeIcon(BoardPanel.class, "/jadex/examples/puzzle/images/red_piece.png"),
		"empty_field", SGUI.makeIcon(BoardPanel.class, "/jadex/examples/puzzle/images/empty_field.png")
	});
	...
	protected void	paintComponent(Graphics g)
	{
		...
		if(lastevent!=null)
		{
			if(lastevent.getPropertyName().equals(IBoard.MOVE))
			{
				g.setColor(Color.green);
				drawArrow(g, (Move)lastevent.getNewValue(), cellw, cellh);
			}
			else if(lastevent.getPropertyName().equals(IBoard.TAKEBACK))
			{
				g.setColor(Color.red);
				Move m = (Move)lastevent.getNewValue();
