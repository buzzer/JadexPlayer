 ...
 */
public class FIPAOntology
{
	//-------- constants --------

	/** The name of the ontology. */
	public static final String	ONTOLOGY_NAME	= "beanynizer_beans_fipa_default";
	...
	static
	{
		...
		nsp[nsp.length-1] = "jadex.adapter.fipa";
		...
		{
			System.out.println("Warning: Cannot set BeanInfo search path 'jadex.adapter.fipa'.");
		}
	}
