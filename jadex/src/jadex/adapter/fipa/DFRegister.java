 ...
 */
public class DFRegister	extends AgentAction implements java.beans.BeanInfo 
{
	//-------- constants ----------
	...
	protected  AgentDescription  result;
	 ...
	 * @return result
	 */
	public AgentDescription  getResult() {
		return this.result;
	}
	 ...
	 */
	public void  setResult(AgentDescription result) {
		this.result = result;
	}
		...
		if(pds==null) {
			try {
				pds = new java.beans.PropertyDescriptor[]{
					 new java.beans.PropertyDescriptor("result", this.getClass(), "getResult", "setResult")
