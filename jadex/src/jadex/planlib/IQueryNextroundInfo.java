...
public interface IQueryNextroundInfo
{
	...
	public static class NextroundInfo
	{
		 ...
		 */
		public NextroundInfo(Object cfp, Object cfp_info, AgentIdentifier[] participants)
		{
			this.cfp	= cfp;
		...
		{
			return (AgentIdentifier[])participants.toArray(new AgentIdentifier[participants.size()]);
		}
