...
public class InteractionState
{
	 ...
	 */
	public void	addCancelResponse(AgentIdentifier responder, String response, Object content)
	{
	...
	public AgentIdentifier[]	getCancelResponders(String response)
	{
		...
		if(cancel_responses!=null)
		{
			...
			ret	= (AgentIdentifier[])list.toArray(new AgentIdentifier[list.size()]);
		}
		else
		{
			ret	= new AgentIdentifier[0];
		}
		return ret;
	}
